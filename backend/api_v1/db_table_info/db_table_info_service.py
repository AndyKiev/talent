...
TABLE_DESCRIPTIONS_EN: dict[str, str] = {
    ...
    "recruitment_application_status_changes": "Candidate application status history",
    "recruitment_applications": "Candidate applications (kanban cards)",
    "recruitment_candidate_notes": "Candidate notes",
    "recruitment_candidate_phones": "Candidate phone numbers",
    "recruitment_candidate_sources": "Candidate sources",
    ...
    "recruitment_interview_feedbacks": "Interview feedback",
    "recruitment_interview_interviewers": "Interview–interviewer links",
    ...
    "recruitment_application_statuses": "Recruitment pipeline statuses (kanban columns)",
