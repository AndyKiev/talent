...
class DbTableInfoService:
    ...
    _DESCRIPTIONS: dict[str, str] = {
        ...
        "employee_departments": "Привязка сотрудников к департаментам",
        ...
        "employee_event_change_dept_types": "Типы изменения департамента в событиях",
        ...
        "employee_language_profiles": "Языковые профили сотрудников",
        "employee_languages": "Конкретные языки сотрудников",
