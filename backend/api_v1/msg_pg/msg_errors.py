from backend.api_v1.base.errors import NotFoundError, AlreadyExistsError
...
class MsgAlreadyExists(AlreadyExistsError):
    ...
    def __init__(self, msg_key_id: int, lang_id: int) -> None:
        ...
        self.fallback = f"Message for key ID {msg_key_id} and lang ID {lang_id} already exists"
