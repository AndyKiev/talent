...
from backend.api_v1.msg_key.msg_key_dependencies import get_msg_key_service, msg_key_by_id
from backend.api_v1.msg_key.msg_key_schema import MsgKey as MsgKeySchema, MsgKeyCreate, MsgKeyUpdate
...
@router.post("", response_model=MsgKeySchema, status_code=status.HTTP_201_CREATED)
...
@router.patch("/{msg_key_id}", response_model=MsgKeySchema)
