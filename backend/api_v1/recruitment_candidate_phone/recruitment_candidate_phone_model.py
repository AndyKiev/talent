...
class RecruitmentCandidatePhone(IntIdPkMixin, Base):
    ...
    __tablename__ = "recruitment_candidate_phones"
    ...
    candidate: Mapped["RecruitmentCandidate"] = relationship(back_populates="phones")

    def __repr__(self) -> str:
        return f"<RecruitmentCandidatePhone(id={self.id}, candidate_id={self.candidate_id})>"
