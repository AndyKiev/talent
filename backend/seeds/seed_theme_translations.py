"""
Insert theme-picker translations directly into the DB (msg_key + msg tables).
No HTTP, no permissions needed.

Run from anywhere:

    python backend/seeds/seed_theme_translations.py

Covers every labelKey in frontend/src/components/theme/themes.ts and every
family header in ThemeSwitch.tsx. Safe to run repeatedly — insert-only, an
existing (key, lang) value is never overwritten.
...
TRANSLATIONS: list[tuple[str, str, str]] = [
    # ── Family section headers (ThemeSwitch menu) ──
    ("familyGraphite", "Graphite", "Графіт"),
    ("familyNeutral", "Neutral", "Нейтральна"),
    ("familyBlue", "Blue", "Синя"),
    ("familySand", "Sand", "Пісочна"),
    ("familyForest", "Forest", "Лісова"),
    ("familyRose", "Rose", "Рожева"),
    ("familyCyan", "Cyan", "Бірюзова"),
    # ── Theme labels (themes.ts labelKey) ──
    ("themeGraphiteLight", "Graphite light", "Графіт світлий"),
    ("themeGraphite", "Graphite", "Графіт"),
    ("themeBlueLight", "Blue light", "Синя світла"),
    ("themeBlueDark", "Blue dark", "Синя темна"),
    ("themeSandDark", "Sand dark", "Пісочна темна"),
    ("themeForestDark", "Forest dark", "Лісова темна"),
    ("themeRoseDark", "Rose dark", "Рожева темна"),
    ("themeCyanLight", "Cyan light", "Бірюзова світла"),
]
