...
TABLE_DESCRIPTIONS_UKR: dict[str, str] = {
    ...
    "application_status_history": "Історія статусів заявок кандидатів",
    "candidate_applications": "Заявки кандидатів (картки канбану)",
    "candidate_notes": "Нотатки про кандидатів",
    "candidate_phones": "Телефони кандидатів",
    "candidate_sources": "Джерела кандидатів",
    ...
    "interview_feedbacks": "Відгуки про співбесіди",
    "interview_interviewers": "Зв'язки співбесіда–інтерв'юер",
    ...
    "pipeline_statuses": "Статуси рекрутингового конвеєра (колонки канбану)",
