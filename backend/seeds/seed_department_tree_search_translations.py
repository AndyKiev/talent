"""
Insert department-tree search/filter translations directly into the DB
(msg_key + msg tables). No HTTP, no permissions needed.

Run from anywhere:

    python backend/seeds/seed_department_tree_search_translations.py
...
TRANSLATIONS: list[tuple[str, str, str]] = [
    ("searchDepartmentName", "department name", "назва підрозділу"),
    ("allDepartmentTypes", "all types", "всі типи"),
    ("allDepartmentCategories", "all categories", "всі категорії"),
]
