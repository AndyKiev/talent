"""
Insert TEMPO album server-side render translations directly into the DB
(msg_key + msg tables). No HTTP, no permissions needed.

    python backend/seeds/seed_tempo_album_translations.py

Covers the strings the TEMPO PDF/PNG album resolves server-side
(review_session_employee_service._tempo_data): the empty-photo placeholder
and the compact age suffix for children ages.
