// src/components/training/training_categories/TrainingCategoryEditDialog.tsx
import {
    Dialog,
    DialogTitle,
    DialogContent,
...
export function TrainingCategoryEditDialog({ pending, isPending, onConfirm, onCancel }: Props) {
