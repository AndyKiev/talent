// src/components/training/employee_training_statuses/EmployeeTrainingStatusEditDialog.tsx
import {
    Dialog,
    DialogTitle,
    DialogContent,
...
export function EmployeeTrainingStatusEditDialog({ pending, isPending, onConfirm, onCancel }: Props) {
