// src/components/admin/departments/DepartmentEditDialog.tsx
import {
  Dialog,
  DialogTitle,
  DialogContent,
...
interface Props {
  pending: PendingDepartmentEdit | null;
  isPending: boolean;
  onConfirm: () => void;
  onCancel: () => void;
}

export function DepartmentEditDialog({ pending, isPending, onConfirm, onCancel }: Props) {
