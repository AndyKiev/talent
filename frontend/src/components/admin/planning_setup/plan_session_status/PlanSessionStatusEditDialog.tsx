// src/components/admin/planning_setup/plan_session_status/PlanSessionStatusEditDialog.tsx
import {
    Dialog,
    DialogTitle,
    DialogContent,
...
export function PlanSessionStatusEditDialog({ pending, isPending, onConfirm, onCancel }: Props) {
