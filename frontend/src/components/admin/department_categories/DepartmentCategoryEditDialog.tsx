// src/components/admin/department_categories/DepartmentCategoryEditDialog.tsx
import {
    Dialog,
    DialogTitle,
    DialogContent,
...
export function DepartmentCategoryEditDialog({ pending, isPending, onConfirm, onCancel }: Props) {
