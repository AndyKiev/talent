// src/components/admin/employee_events/employee-event-statuses/EmployeeEventStatusForm.tsx
...
interface Props {
  ...
  createMutation: UseMutationResult<
    MutationResponse<EmployeeEventStatus>,
    Error,
    EmployeeEventStatusCreate
  >;
}

export function EmployeeEventStatusForm({ open, onClose, createMutation }: Props) {
  ...
  return (
    <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth>
      <DialogTitle>
        {cfl(getString('createEmployeeEventStatus') || 'Create Employee Event Status')}
      </DialogTitle>
      <DialogContent>
