// src/components/admin/employee_events/employee_event-statuses/EmployeeEventStatusEditDialog.tsx
import {
  Dialog,
  DialogTitle,
  DialogContent,
...
export function EmployeeEventStatusEditDialog({ pending, isPending, onConfirm, onCancel }: Props) {
