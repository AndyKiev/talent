// src/components/admin/employee_events/employee_event_direction_types/EmployeeEventDirectionTypeEditDialog.tsx
import {
    Dialog,
    DialogTitle,
    DialogContent,
...
export function EmployeeEventDirectionTypeEditDialog({
    pending,
    isPending,
    onConfirm,
    onCancel,
