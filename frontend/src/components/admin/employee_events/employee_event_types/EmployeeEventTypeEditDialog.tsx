// src/components/admin/employee_event_types/EmployeeEventTypeEditDialog.tsx
import {
    Dialog,
    DialogTitle,
    DialogContent,
...
export function EmployeeEventTypeEditDialog({ pending, isPending, onConfirm, onCancel }: Props) {
