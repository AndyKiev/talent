// src/components/admin/employee_events/employee_event_change_dept_types/EmployeeEventChangeDeptTypeForm.tsx
...
interface Props {
    ...
    createMutation: UseMutationResult<
        MutationResponse<EmployeeEventChangeDeptType>,
        Error,
        EmployeeEventChangeDeptTypeCreate
    >;
}

export function EmployeeEventChangeDeptTypeForm({ open, onClose, createMutation }: Props) {
    ...
    return (
        <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth>
            <DialogTitle>
                {cfl(getString('createEmployeeEventChangeDeptType')) || 'Create Employee Event Change Dept Type'}
            </DialogTitle>
            <DialogContent>
