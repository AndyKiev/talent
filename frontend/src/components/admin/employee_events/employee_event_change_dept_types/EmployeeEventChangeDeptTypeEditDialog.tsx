// src/components/admin/employee_events/employee_event_change-dept_types/EmployeeEventChangeDeptTypeEditDialog.tsx
import {
    Dialog,
    DialogTitle,
    DialogContent,
...
export function EmployeeEventChangeDeptTypeEditDialog({
    pending,
    isPending,
    onConfirm,
    onCancel,
