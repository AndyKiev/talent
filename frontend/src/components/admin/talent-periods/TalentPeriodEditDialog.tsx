// src/components/admin/talent-periods/TalentPeriodEditDialog.tsx
//
...
export interface PendingEdit {
    id: number;
    /** Human-readable field label, e.g. "Name" */
    fieldLabel: string;
    /** The raw backend field name, e.g. "name" */
    field: string;
...
export function TalentPeriodEditDialog({ pending, isPending, onConfirm, onCancel }: Props) {
