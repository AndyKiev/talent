// src/components/organigram/OrganigramDateWheelPicker.tsx
//
// Local copy of the iOS-style 3-wheel (year / month / day) scroll picker so
// the organigram folder stays standalone (original lives under
// people-review/personal-data). No external dependency: CSS scroll-snap does
// the snapping, we read the centered item once scrolling settles. Value is an
...
export default function OrganigramDateWheelPicker({
    value,
    onChange,
    minYear,
    maxYear,
    ...
    const base = value ? dayjs(value) : today;
